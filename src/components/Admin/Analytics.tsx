...
export const Analytics: React.FC = () => {
  ...
  const engagementData = [
    { level: 'High Achievers', count: 15, percentage: 25 },
    { level: 'Active Students', count: 25, percentage: 25 },
    { level: 'Moderate Participation', count: 35, percentage: 25 },
    { level: 'Low Engagement', count: 25, percentage: 25 }
  ];
